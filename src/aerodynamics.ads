...
package Aerodynamics is
   ...
   function Get_CN (This : Component'Class; Max_Diameter : Float) return Float;
   function Get_CP (This : Component'Class) return Float;

   function Get_Total_CN (This : Component'Class; Max_Diameter : Float) return Float;
   function Get_Total_CP (This : Component'Class; Max_Diameter : Float) return Float;
   function Get_Total_CDA (This : Component'Class) return Float;
